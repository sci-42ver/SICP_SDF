...
(define (queens board-size)
  ...
  ;; 1. amb is not procedure. TODO so how to do (amb (to-args (all-combinations board-size))) where to-args is what to be done when apply.
  (let ((rows (apply amb (all-combinations board-size))))
