...
;; > A named let can also be an alternative to the following procedure
;; is wrong since `(let-body expr)` can't access func name.
;; > Instead of a for loop, let’s consider a while loop...
